function BHPassiveExplosivePoisonDamage( keys )
	...
	-- kv
	local explosivePoisonWeaponDamageMultiplyer = ability:GetLevelSpecialValueFor("explosive_poison_weapon_damage", 0)
	...
	local damageTable = {
		...
		damage = caster_base_damage * explosivePoisonWeaponDamageMultiplyer
	}
...
function BHPassiveExplosivePoisonDamageCritical( keys )
	...
	local caster_combined_damage_value = caster_base_damage * explosivePoisonWeaponDamageMultiplyer
