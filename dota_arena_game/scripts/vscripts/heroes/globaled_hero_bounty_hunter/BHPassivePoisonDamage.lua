function BHPassivePoisonDamage( keys )
	...
	-- kv
	local poisonWeaponDamageMultiplyer = ability:GetLevelSpecialValueFor("poison_weapon_damage_multiplier", 0)
	...
	local damageTable = {
		...
		damage = caster_base_damage * poisonWeaponDamageMultiplyer,
	}
	 
	ApplyDamage(damageTable)
end

function BHPassivePoisonDamageCritical( keys )
